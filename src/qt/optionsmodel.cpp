...
void OptionsModel::Init()
{
    ...
    fUsebitvierTheme = settings.value("fUsebitvierTheme", true).toBool();	
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UsebitvierTheme:
            return QVariant(fUsebitvierTheme);			
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UsebitvierTheme:
            fUsebitvierTheme = value.toBool();
            settings.setValue("fUsebitvierTheme", fUsebitvierTheme);
            break;			
        default:
            break;
        }
