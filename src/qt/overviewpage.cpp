    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the bitvier network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the bitvier network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("bitvier")
    updateDisplayUnit();
}
